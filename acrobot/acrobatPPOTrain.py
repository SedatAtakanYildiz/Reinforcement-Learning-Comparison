...
# CSV kaydı
with open("results/ppo_acrobot_results.csv", "w", newline="") as f:
    writer = csv.writer(f)
...
# Grafik
plt.plot(rewards)
plt.title("PPO - Acrobot Learning Curve (500 Episode)")
plt.xlabel("Episode")
plt.ylabel("Reward")
plt.grid()
plt.savefig("results/ppo_acrobot_learning_curve.png")
plt.close()